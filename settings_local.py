...
"""
ADMINS = (('Ulysseus Digital Unit', 'digitalplatform@ulysseus.eu'),)
...
"""
LANGUAGES = (
    ('en', 'English'), ('fr', 'Français'), ('nl', 'Dutch (Netherlands)')
)
...
"""
# Si True, l'onglet types de la barre de menu ne sera plus visible
"""
HIDE_TYPES = False
...
"""
# Permet d'activer le studio Opencast dans Pod
"""
...
# les valeurs possibles sont "mid" (ecran et caméra ont la même taille)
# "piph" (le presenteur, caméra, est inscruté dans la vidéo de présentation, en haut à droite)
# "pipb" (le presenteur, caméra, est inscruté dans la vidéo de présentation, en bas à droite)
"""
OPENCAST_DEFAULT_PRESENTER = "mid"
"""
# Contenu par défaut du fichier xml pour créer le mediapackage pour le studio.
# ce fichier va contenir toutes les spécificités de l'enregistrement (source, cutting, title, presenter etc.)
"""
...
TEMPLATE_VISIBLE_SETTINGS = {
    # Titre du site.
    'TITLE_SITE': 'Ulysseus Videos',

    # Description du site.
    'DESC_SITE': 'Ulysseus Videos allow Ulysseus community to share video content in a seemless way.',
...
"""
DEFAULT_DC_COVERAGE = TEMPLATE_VISIBLE_SETTINGS['TITLE_ETB'] + " - Town - Country"
...
# Pour l'encodage distant, il faut préciser "start_studio_remote_encode"
"""
ENCODE_STUDIO = "start_encode_studio"
"""
# pour l'encodage distant du studio, voici les paramètres possibles :
# SSH_REMOTE_STUDIO_USER = "pod"
# SSH_REMOTE_STUDIO_HOST = "xxx.univ.fr"
# SSH_REMOTE_STUDIO_PORT = "22"
# SSH_REMOTE_STUDIO_KEY = "/home/pod/.ssh/id_rsa"
# remote command to launch for studio, here is the arguments needed:
# -n recording-<recording_id> -v <presenter_source}> -f <presentation_source}>
# -r <recording_id> -s <subtime> -p <presenter> -o <output> -d <debug>
# SSH_REMOTE_STUDIO_CMD = ""
"""
...
"""
BBB_SERVER_URL = 'https://rooms.ulysseus.eu/'
